 ...
 * @author kevin
 */
public class ServletListeTicket extends HttpServlet {
...
//        System.out.println("ServletListeTicket");
        ...
        String jsonResp = HttpConnVaccinationCenter.HttpConnection(json, "http://localhost:8080/CentreVaccination/ServletGetListeDesTickets");
