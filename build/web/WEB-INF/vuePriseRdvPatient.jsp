    ...
    <body>
        ...
        <div id="datepicker-div">
            <div id="datepicker">
                ...
                <button id="buttonRdv" onclick="showDateMinPicker()">Pour prendre rendez-vous, c'est par ici !</button>
                <input id="dateMin" hidden> 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="sendData()" data-bs-dismiss="modal">Enregister</button>
                    </div>
                </div>
            </div>
        </div>
