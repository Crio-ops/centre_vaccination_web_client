 ...
 * @author kevin
 */
public class ServletGetListCitoyens extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String json = ob.writeValueAsString(bpc);
         System.out.println("Front role : " + bpc);
        String jsonResp = HttpConnVaccinationCenter.HttpConnection(json, "http://localhost:8080/CentreVaccination/ServletListeCitoyens");
         lc = ob.readValue(jsonResp, new TypeReference<ArrayList<Citoyens>>(){});
         for(Citoyens c : lc){
             System.out.println("CITOYENS : " +c.toString());
         }
