...
public class ServletValiderLaVaccination extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("Valider vaccination " + bt);
        String json = ob.writeValueAsString(bt);

        String jsonResp = HttpConnVaccinationCenter.HttpConnection(json, "http://localhost:8080/CentreVaccination/ServletValiderLaVaccination");

        System.out.println("retour validation : " + jsonResp);
