 ...
 * @author kevin
 */
public class ServletGetRdvVaccinD2 extends HttpServlet{
     protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("Mon RDV : " + rdv);
        String json = ob.writeValueAsString(rdv); 
        String jsonResp = HttpConnVaccinationCenter.HttpConnection(json, "http://localhost:8080/CentreVaccination/ServletConfirmationRdvDose2");
